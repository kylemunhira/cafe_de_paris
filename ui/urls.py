...
urlpatterns = [
    ...
    path("order-papers/", views.OrderPapersView.as_view(), name="order-papers"),
    ...
    path("wastage/", views.WastageView.as_view(), name="wastage"),
    ...
    path(
        "central-invoices/<int:pk>/print/",
        views.CentralInvoicePrintView.as_view(),
        name="central-invoice-print",
    ),
    ...
    path(
        ...
        views.VoidedItemsReportView.as_view(),
